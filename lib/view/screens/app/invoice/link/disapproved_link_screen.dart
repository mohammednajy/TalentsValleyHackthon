...
class DisapprovedLinkScreen extends StatelessWidget {
  const DisapprovedLinkScreen({Key? key}) : super(key: key);
        ...
        child: Column(
          ...
          children: [
            ListTile(
              ...
              title: const Text('Disapproved', style: TextStyle(fontSize: 15,fontWeight: FontWeight.bold,),),
                ...
                child: Row(
                  ...
                  children: [
                    Column(
                      mainAxisAlignment: MainAxisAlignment.spaceBetween,
                      children: const [
                        Text('Balance',style: TextStyle(fontSize: 13,color: AppColor.subtitleColor),),
                        SizedBox(height: 10,),
                    ...
                    Column(
                      mainAxisAlignment: MainAxisAlignment.spaceBetween,
                      children: const [
                        Text('Fees',style: TextStyle(fontSize: 13,color: AppColor.subtitleColor),),
                        SizedBox(height: 10,),
                        Text('\$0.00',style: TextStyle(fontSize: 13),)
                      ],
                    ),
                    Column(
                      mainAxisAlignment: MainAxisAlignment.spaceBetween,
                      children: const [
                        Text('Total',style: TextStyle(fontSize: 13,color: AppColor.subtitleColor),),
                        SizedBox(height: 10,),
                        Text('\$0.00',style: TextStyle(fontSize: 13),)
                      ],
                    ),
            ...
            CustomCardWidget(
              horizontalPadding: 34,verticalPadding: 15,
              child: Column(
                crossAxisAlignment: CrossAxisAlignment.start,
                children: [
